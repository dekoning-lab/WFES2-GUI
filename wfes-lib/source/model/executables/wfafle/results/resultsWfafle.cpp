...
ResultsWfafle::ResultsWfafle()
    : time(std::nan("")), error("") {}

ResultsWfafle::ResultsWfafle(double time)
    : time(time), error("") {}

ResultsWfafle::ResultsWfafle(std::string error)
    : time(std::nan("")), error(error) {}

ResultsWfafle::ResultsWfafle(dvec probs, double time)
